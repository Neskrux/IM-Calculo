...
import logoAilosUrl from '../imgs/ailos-logo.png'

// Logo oficial (PNG importado pelo Vite → data URL/asset URL)
let LOGO_AILOS = logoAilosUrl
 ...
 */
export function gerarBoletoPdfDoc(dados) {
...
/** Devolve o PDF como base64 (sem prefixo data:) — pra enviar ao servidor. */
export function gerarBoletoPdfBase64(dados) {
  const doc = gerarBoletoPdfDoc(dados)
