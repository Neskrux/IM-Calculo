...
@.Codex/rules/fator-comissao.md
@.Codex/rules/comissao-corretor.md
@.Codex/rules/comissao-integral-20.md

## Regras de sincronização (carregadas automaticamente)

@.Codex/rules/sincronizacao-sienge.md

## Regras de visualização e processo (carregadas automaticamente)

@.Codex/rules/visualizacao-totais.md
@.Codex/rules/rodadas-b.md
...
- [docs/pendencias-para-revisao-2026-05-14.md](docs/pendencias-para-revisao-2026-05-14.md) — **investigação 2026-05-14** dos casos da revisão humana:
